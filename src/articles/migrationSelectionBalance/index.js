            ...
            <ArticleWrapper ref={articleRef}>
                ...
                <ArticleBody hasTOC={true}>
                    <ArticleContent>
                        ...
                        <ArticleText>
                            Migration rate has one of the greatest effects on how the simulations evolve. If migration rate is low, then the populations rapidly diverge in phenotype and the genetic architecture tends to be very constant over time <ActionButton onClick={() => handleSetParam('m0.0001_mu0.00001_r0.00625_sigsqr2_n10000_pop1_alpha0.05')}>(m = 0.001)</ActionButton>. At higher migration rates, we tend to see a change in genetic architecture: simulations start with many loci making small contributions to divergence but over time evolve towards a more clustered architecture with fewer, larger, and more tightly clustered alleles driving the divergence <ActionButton onClick={() => handleSetParam('m0.1_mu0.00001_r0.00625_sigsqr2_n10000_pop1_alpha0.05')}>(m = 0.1)</ActionButton>. These simulations show very strong selection – if we weaken the strength of selection at very high migration rates, we see a change to a transient architecture where no locus contributes to divergence for long and there is little phenotypic divergence maintained <ActionButton onClick={() => handleSetParam('m0.1_mu0.00001_r0.00625_sigsqr25_n10000_pop1_alpha0.05')}>(vs = 25, m = 0.1)</ActionButton>.
                        </ArticleText>
                        <ArticleText>
                            Why do these changes occur? Part of the explanation lies in the simple model from Haldane and Wright – when migration rates are very low relative to the strength of selection on each allele then individual alleles tend to contribute to divergence for a long time. In these simulations there is no selection coefficient (s) defined for each allele, but alleles that have bigger effects on the phenotype tend to experience stronger selection through their effects on the phenotype, so we can still think of them as if they have a selection coefficient. At intermediate migration rates, some smaller alleles may be too weakly selected to persist for long because they are falling into the region of parameter space where the selection they experience is of similar magnitude to the migration rate (s ≅ m), whereas larger alleles are still strongly selected relative to migration (s {">"} m) and persist. Interestingly, clusters of small alleles that are close together on a chromosome can behave as if they were a single larger allele, because the rate of recombination between is lower so they tend to be inherited together. As a result when migration rates are intermediate, genetic architecture tends to evolve towards either clustering of small alleles, or a few large alleles driving divergence. Then, at very high migration rates relative to the strength of selection, there may be no alleles that experience selection strong enough to maintain divergence (s {"<"} m), and then very little local adaptation is maintained.
                        </ArticleText>
